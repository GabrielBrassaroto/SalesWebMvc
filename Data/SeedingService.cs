...
{
    public class SeedingService //// injecao de indepedencias
    {
        private SalesWebMvcContext _context; // cria o contexto da model 
        
        public SeedingService(SalesWebMvcContext context)// contrutor receber o tipo para a indepedencia acontecer
        {
            _context = context;//injecao de indepencia
        }
        ...
        public void Seed()/// popular a base de dados 
        {
            ...
            Departament d4 = new Departament { Id = 4, Name = "Books" };// outro jeito de adicionar no contrutor
